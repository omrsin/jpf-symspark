...
/**
 * Example with a single flatMap transformation implemented
 * as an anonymous function.
 * Expected analysis result [-1000000, 3]
 * Expected execution result [4, 8, 15, 9, 15, 9, 20, 12]
...
public class SingleIntegerFlatMapExample {
	public static void main(String[] args) {
		...
		System.out.println("Expected execution result [4, 8, 15, 9, 15, 9, 20, 12]");
